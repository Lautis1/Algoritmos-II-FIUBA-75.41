...
grafo = grafo_crear("actors.csv")
print(popularidad(grafo,'Bacon Kevin'))
print(similares(grafo, 'Bacon Kevin', 2))
print(camino(grafo, "Eastwood Clint", "Bale Christian"))
print(actores_a_distancia(grafo, "Eastwood Clint", 2))